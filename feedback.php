...
<title>EduMetrica || FEEDBACK </title>
...
<!--header start-->
<div class="row header" style="background-color:#165188">
<div class="col-lg-6">
...
<div class="col-md-10">
<a href="mailto:sitalmandal.info@gmail.com" style="color:#000000">Arjunraaz0@gmail.com</a><br /><br />
...
<!--Footer start-->
<div class="row footer" style="background-color:#165188">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/Arjun.jpg" width=100 height=100 alt="Arjun Timsina" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://sitalmandal.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Arjun Timsina</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8317324484</h4>
		<h4 style="font-family:'typo' ">Arjunraaz0@gmail.com</h4>
		<h4 style="font-family:'typo' ">Kankai-1,Jhapa</h4></div></div>
		</p>
      </div>
      <div class="modal-body">
        <p>
		<div class="row">
		<div class="col-md-4">
		 <img src="image/amu.jpg" width=100 height=100 alt="Amisha Nepal" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://sitalmandal.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Amisha Nepal</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">9815952840</h4>
		<h4 style="font-family:'typo' ">Amishanepal22@gmail.com</h4>
		<h4 style="font-family:'typo' ">Bhadrapur -08,Jhapa</h4></div></div>
		</p>
      </div>
